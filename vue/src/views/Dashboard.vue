    ...
    <PageComponent>
        ...
        >
            ...
            >
                ...
                <div v-if="data.latest_survey">
                    <img
                        :src="data.latest_survey.image_url"
                        class="w-[240px] mx-auto"
                        alt=""
                    />
                    <h3 class="font-bold text-xl mb-3">{{ data.latest_survey.title }}</h3>
                    ...
                    <div class="flex justify-between">
                        <router-link
                            :to="{ name: 'SurveyView', params: { id: data.latest_survey.id } }"
            ...
            >
                ...
                <div v-if="data.latest_five_answer.length">
                    <a
                        href="#"
                        v-for="answer of data.latest_five_answer"
                        :key="answer.id"
