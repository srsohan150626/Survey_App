...
<template>
            <div>
                <img class="mx-auto" style="height: 200px;width: 200px;" src="../assets/survey.png" alt="Workflow" />
                <h2 class="text-center text-3xl font-extrabold text-gray-900" style="margin-top: -60px;">Log in to your account</h2>
